...
const generateShips = (player1, player2, startingPlayer, gameBoardSize) => {
  ...
  generatePlayerTurns(player1, player2, startingPlayer, gameBoardSize); //console.log("all player 1 postions" + allPlayer1Pos);
